...
- Toute affirmation factuelle sur le produit doit rester vérifiable. Intègre naturellement la source dans ta rédaction (ex: « selon les tarifs officiels ») SANS JAMAIS utiliser de marqueurs de type [S1], ni annoncer un nombre de sources vérifiées ou une bibliographie en fin de page.
