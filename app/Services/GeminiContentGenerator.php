...
- COMPATIBILITÉ ET STATUTS JURIDIQUES : Si l'outil n'est pas explicitement compatible avec un statut juridique (ex: associations loi 1901), une activité ou un régime fiscal dans les preuves, refuse toute promesse commerciale. Indique clairement son incompatibilité dès l'introduction et ne construis jamais un guide d'utilisation sur une prémisse fausse.
