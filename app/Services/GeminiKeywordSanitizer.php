...
REJET STRICT ("keep": false) : Si le mot-clé traite d'un autre domaine (RH, immobilier, transport, énergie, médical, e-commerce, annonces, EDF, Doctolib, Hub Pro Transport, LeBonCoin, etc.), TU DOIS LE REJETER.
Attention : ne rejette JAMAIS les mots-clés qui contiennent "facturation", "comptabilité", "devis", "banque pro", "sasu", "auto-entrepreneur".

Renvoie un tableau JSON contenant TOUS les mots-clés fournis en entrée, avec la valeur "keep" appropriée pour chacun.
