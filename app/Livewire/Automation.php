...
class Automation extends Component
{
    ...
    {
        $diversity = "\n\nREGLE ABSOLUE : Tu dois OBLIGATOIREMENT diversifier les sujets. Interdiction totale de proposer plus d'UNE seule idée sur le même sous-sujet.\nCompare chaque idée proposée à la liste des titres déjà publiés fournie en contexte, tous content_types confondus, et évite strictement tout sujet déjà traité sous un angle proche.";
        ...
        if ($type === 'pillar') {
            ...
            $this->instructions = "Objectif : Money Pages / Conversion. Requêtes ultra-spécifiques et transactionnelles. Inclure systématiquement des tableaux de prix, la mention d'un simulateur, et exiger dans le brief des CTA clairs et incitatifs (sans jamais inventer d'avantages non sourcés à l'étape de rédaction).\nCONTRAINTE DE RIGUEUR : Le brief produit doit exiger du rédacteur une vérification stricte des prix et fonctionnalités à la date de publication." . $diversity;
            ...
            $this->instructions = "Objectif : Expansion combinatoire (Libre, pas limité aux mots-clés stricts). Générer des sujets de type alternatives, comparatifs ou cas d'usage croisés.\n" .
                "CONTRAINTE STRATÉGIQUE (PARTENAIRE) : Sur chaque lot d'idées générées, au moins 70% doivent positionner le produit promu par ce projet (utilise son VRAI nom, n'écris jamais l'expression 'Notre Outil') comme sujet central ou comparé (Produit vs X, Produit comme alternative à X, Produit en recommandation). Un maximum de 30% d'idées par lot peut être une page d'interception pure (comparatif entre deux concurrents sans le produit, listicle neutre) — et dans ce cas, le brief DOIT explicitement exiger que le produit promu soit mentionné comme option pertinente dans le corps de l'article, avec CTA, même absent du titre.\n" .
                "RÈGLE D'OBJECTIVITÉ (INFORMATIONAL) : Si le type est 'informational' (pilier, guide de définition ou concept), l'article DOIT rester parfaitement neutre et objectif. Ne biaise pas le titre en faveur du produit (ex: 'Comment Produit aide...'). Le produit ne peut être qu'une mention naturelle à la fin. Les types 'commercial' ou 'alternatives' assument en revanche leur biais de recommandation.\n" .
