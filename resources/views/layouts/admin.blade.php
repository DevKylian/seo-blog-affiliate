    ...
    <div class="admin-shell">
        ...
        <aside class="sidebar" :class="{ 'is-open': sidebarOpen }">
            ...
            <nav class="nav-menu">
                ...
                <a class="nav-item {{ request()->routeIs('admin.editorial-pipeline') ? 'active' : '' }}" href="{{ route('admin.editorial-pipeline') }}" wire:navigate><svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 9h-2V7h-2v5H6v-2h2V7c0-1.1.9-2 2-2h2v2h2v5zm4 4h-8v-2h8v2z"/></svg>Pipeline Editorial <small>Agents</small></a>
                <a class="nav-item {{ request()->routeIs('admin.generate-comparisons') ? 'active' : '' }}" href="{{ route('admin.generate-comparisons') }}" wire:navigate><svg viewBox="0 0 24 24"><path d="M13 2L3 14h7v8l10-12h-7V2z"/></svg>Générateur Comparatifs <small style="color:#818cf8; font-weight:800;">1-Click</small></a>
