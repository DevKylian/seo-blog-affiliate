    ...
    <div class="admin-shell">
        ...
        <aside class="sidebar" :class="{ 'is-open': sidebarOpen }">
            ...
            <nav class="nav-menu">
                ...
                <a class="nav-item {{ request()->routeIs('admin.seo-engine') ? 'active' : '' }}" href="{{ route('admin.seo-engine') }}" wire:navigate><svg viewBox="0 0 24 24"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>SEO Engine</a>
