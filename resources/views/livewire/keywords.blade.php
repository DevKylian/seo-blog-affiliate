<div class="dashboard-page os-page">
    ...
    <article class="panel">
        <div class="panel-head"><div><h2>Opportunités éditoriales</h2><p>Score 0–100 selon volume, difficulté, intention et potentiel affilié</p></div><div class="search-box" style="display: flex; gap: 12px; align-items: center;"><button class="secondary-button" type="button" wire:click="analyzeForCleaning" wire:loading.attr="disabled" style="border: 1px solid #cbd5e1; background: white; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 13px; font-weight: 500; color: #475569; display: flex; align-items: center; gap: 6px;">✨ <span wire:loading.remove wire:target="analyzeForCleaning">Nettoyer avec l'IA</span><span wire:loading wire:target="analyzeForCleaning">Analyse en cours...</span></button><button class="secondary-button" wire:click="exportCsv" type="button" style="border: 1px solid #cbd5e1; background: white; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 13px; font-weight: 500; color: #475569; display: flex; align-items: center; gap: 6px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> Exporter (CSV)</button><div><span>⌕</span><input wire:model.live.debounce.300ms="search" type="search" placeholder="Rechercher…"></div></div></div>
