<div class="dashboard-page os-page">
    ...
    <details class="panel project-form-disclosure" @if($editingId) open @endif>
        ...
        <form wire:submit="createProject" class="os-form">
            ...
            <div class="field full"><label style="display:flex; align-items:center; gap:8px; cursor:pointer;"><input type="checkbox" wire:model="hasEInvoicing" style="width:auto; margin:0;"> Activer le badge "Facturation électronique 2026"</label></div>
