...
@section('title', 'À propos de BusinessKit - Martin Trivianio')
@section('description', 'Découvrez la méthodologie de BusinessKit et son créateur, Martin Trivianio, spécialiste des logiciels B2B pour indépendants.')
...
<main style="max-width: 800px; margin: 60px auto; padding: 0 24px;">
    ...
    <div style="display: flex; gap: 40px; align-items: flex-start; margin-bottom: 60px;">
        ...
        <div>
            ...
            <a href="https://linkedin.com/in/martintrivianio" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 8px; font-weight: 700; color: #0077b5; text-decoration: none;">
