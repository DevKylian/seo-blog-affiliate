            ...
            @if($isIndy)
                <aside class="premium-cta-indy {{ $positionClass }}">
                    ...
                    <div class="premium-cta-indy__content">
                        ...
                        <div class="premium-cta-indy__testimonial" style="grid-column: 1 / -1; margin-top: 20px; padding: 14px; background: #f8fafc; border-radius: 8px; font-size: 14px; font-style: italic; border-left: 4px solid #3b82f6; width: 100%; box-sizing: border-box; display: block;">
