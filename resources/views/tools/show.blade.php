        ...
        <div>
            <div class="review-title-block">
                ...
                <div>
                    ...
                    @if($tool->has_e_invoicing)
                        <div style="margin-top: 14px;">
                            <span style="display:inline-flex; align-items:center; gap:6px; font-size:12px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 6px 14px; border-radius: 100px; font-weight: 700; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.25); letter-spacing: 0.2px;">
